import {ArrowFunction, FunctionDeclaration, FunctionExpression, MethodDeclaration, MethodSignature} from 'ts-morph';
import {AstNode, ParserContext} from '../types.js';
import {getEndColumn, getJsDocDescription, getNodeType} from '../../utils/ts-helpers.js';
        ...
        for (const param of parameters) {
            try {
                ...
                const paramNode: AstNode = {
                    id: generateId('parameter', qualifiedName, {
                        line: param.getStartLineNumber(),
                        column: param.getStart() - param.getStartLinePos()
                    }),
                    entityId,
                    kind: 'Parameter',
                    name,
