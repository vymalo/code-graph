import {ArrowFunction, FunctionDeclaration, FunctionExpression, Node, ts} from 'ts-morph';
import {AstNode, ParserContext} from '../types.js';
import {getEndColumn, getFunctionReturnType, getJsDocText, getNodeName} from '../../utils/ts-helpers.js';
