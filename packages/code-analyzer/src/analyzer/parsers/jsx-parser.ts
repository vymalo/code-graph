...
import {JsxAttribute, JsxElement, JsxSelfClosingElement, Node, SyntaxKind, ts} from 'ts-morph';
import {ComponentNode, JSXAttributeNode, JSXElementNode, ParserContext, TailwindClassNode} from '../types.js';
