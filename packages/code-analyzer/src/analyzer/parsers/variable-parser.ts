import {Node, ts, VariableDeclarationKind} from 'ts-morph'; // Import VariableDeclarationKind
import {AstNode, ParserContext} from '../types.js';
import {getEndColumn, getJsDocText, getNodeName, getNodeType} from '../../utils/ts-helpers.js';
